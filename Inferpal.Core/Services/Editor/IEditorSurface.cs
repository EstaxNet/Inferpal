...
internal interface IEditorSurface
{
    ...
    /// <remarks>
    /// <para>
    /// <b>Who has to check it.</b> The line is <i>assertion</i> versus <i>hint</i>, not "is this a
    /// tool":
    /// </para>
    /// <list type="bullet">
    ...
    ///   Without the check, <c>get_open_editors</c> answers "No files are currently open in the
    ///   editor" whenever the surface itself is what is missing — two tools then give opposite
    ///   answers about the same session, and the model cannot prefer the true one.</item>
